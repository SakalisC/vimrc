...
set smarttab
set autoindent 
set formatopts+=j " When joining comments, remove the comment leader
set formatopts+=c " Autoformat comments but not text
set formatopts+=l " Do not break lines already long in insert mode
